...
Ext.define('Ext.ux.calendar.editor.EventEditor', {
	extend : 'Ext.form.FormPanel',
	initComponent : function() {
		this.ehandler.applyCalendarSetting(this);
		var lan = Ext.ux.calendar.Mask.Editor;

		this.timeField = this.timeField ||Ext.create('Ext.util.LabelField', {
					fieldLabel : lan['startDayField.label'],
					anchor : '99%'
				});

		this.subjectField = this.subjectField || Ext.create('Ext.form.TextField', {
					fieldLabel : lan['subjectField.label'],
					anchor : '99%'
				});

		this.contentField = this.contentField ||  Ext.create('Ext.form.TextField', {
		...
		this.alertCB = this.alertCB || Ext.create('Ext.form.Checkbox', {
					anchor : '99%',
					boxLabel : lan['alertCB.label']
				});

		this.deleteBtn = this.deleteBtn || Ext.create('Ext.Button', {
		...
		this.detailBtn = this.detailBtn ||Ext.create('Ext.Button', {
		...
		Ext.apply(this, {
					...
					items : [this.timeField, this.subjectField,
							this.contentField, {
								anchor : '99%',
								xtype : 'container',
								layout : 'column',
